...
<!-- END SHORTCUT ICON -->
<title>流量运营分析 - TEST®全站数据平台</title>
<!-- BEGIN STYLESHEET-->
...
<body>
	...
	<section id="container">
		...
		<header class="header white-bg">
			...
			<a href="index.html" class="logo"> FGM <span> TEST </span><span>
					全站流量运营分析 </span>
			</a>
			<!-- START HEADER  NAV -->
		...
		<footer class="site-footer">
			<div class="text-center">
				2017 &copy; TEST by <a href="" target="_blank"> www.xxx.cn
					 </a> <a href="http://www.xxx.con" class="go-top"> <i
